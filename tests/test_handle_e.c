...
{
    int cnt = my_printf("%e %e %e %e %e %e", 2.0, 14.46, -3.7, 0.78, -0.007, 12345678910.0);
    //receive_output("scientific_notation_lower_test.txt");
    cr_assert_stdout_eq_str("2.000000e+00 1.446000e+01 -3.700000e+00 7.800000e-01 -7.000000e-03 1.234567e+10");
    cr_assert_eq(cnt, 79);
}
